    ...
    methods:{
      ...
      openEdit(yjnums){
        ...
        if(yjnums==0){
          ...
          this.value1 = [this.workrow.b_id,this.workrow.c_id]
      ...
      updateWork(){
        ...
        this.workrow.c_id=this.value1[1]
        ...
        if(!this.date){
          ...
          this.$axios.post('/updateWork','w_id='+this.workrow.w_id+'&t_id='+store.state.user.username+'&b_id='+this.workrow.b_id+'&c_id='+this.workrow.c_id+'&begindate='+this.workrow.begindate+'&enddate='+this.workrow.enddate+'&jianjie='+this.workrow.jianjie).then(successResponse => {
            if (successResponse && successResponse.status === 200) {
