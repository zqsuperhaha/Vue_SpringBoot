<template>
  ...
  <el-form-item>
    ...
    <el-upload
      ...
      <div class="el-upload__tip" slot="tip">只能上传{{oktype}}文件，且每个大小不超过{{maxSize}}{{maxUnit}}，多于1个文件请打包上传</div>
    ...
    export default {
      ...
      methods:{
        ...
        handleExceed(files, fileList){
          this.$message.warning(`当前限制只能选择 1 个文件！(请打包上传！)`);
        },
